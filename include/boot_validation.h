...
typedef enum {
  ...
  BOOT_ERROR_NETWORK = 13,
  BOOT_ERROR_INPUTS = 14,
  BOOT_ERROR_ENCODER_DIAG = 15,
  BOOT_ERROR_LOAD_MGR = 16,
  BOOT_ERROR_DASHBOARD = 17,
  BOOT_ERROR_AXIS_SYNC = 18,
  BOOT_ERROR_LCD = 19,
  BOOT_ERROR_AUTH = 20,
  BOOT_ERROR_RECOVERY = 21,
  BOOT_ERROR_TACHOMETER = 22,
  BOOT_ERROR_SD_CARD = 23,
  BOOT_ERROR_ALERTS = 24,
  BOOT_ERROR_PREALLOC = 25,
  BOOT_ERROR_SPINDLE = 26,
  BOOT_ERROR_JOB_MGR = 27,
