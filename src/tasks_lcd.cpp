...
void taskLcdFunction(void *parameter) {
 ...
 // Initialize LCD message system for M117 support
 lcdMessageInit();
 ...
 // Get encoder health for display
 ...
 // Check for custom LCD message from M117 G-code
