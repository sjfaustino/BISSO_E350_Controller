 ...
 * @brief Telemetry & Web UI Update Task
...
#include "altivar31_modbus.h" // VFD current monitoring
#include "jxk10_modbus.h" // JXK-10 Spindle Current
#include "axis_synchronization.h" // Axis validation
...
#include "encoder_diagnostics.h" // Encoder health monitoring
...
#include "vfd_current_calibration.h" // Current calibration
...
void taskTelemetryFunction(void *parameter) {
 ...
 // Respect Load Manager suspension (Memory Stability Fix)
 ...
 // ESP-NOW Remote DRO Broadcast (10Hz)
 ...
 // Dynamic refresh rate based on system load/fragmentation
