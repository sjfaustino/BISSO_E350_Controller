...
// Ring buffer fallback for queue overflow (Size defined in system_tuning.h)
static struct {
...
// Add fault to ring buffer fallback
...
void faultClearHistory() {
 ...
 // Clear ring buffer fallback as well
...
void emergencyStopSetActive(bool active) {
 ...
 // Signal event group for emergency stop
 ...
 // Signal event group for E-STOP release
...
// Ring buffer diagnostics functions
