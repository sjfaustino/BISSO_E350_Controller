 ...
 * @brief System Telemetry Implementation
 */
...
// Track WiFi connection state changes for event signaling
...
void telemetryUpdate() {
 ...
 // =========================================================================
 // Collect all data OUTSIDE critical section
 ...
 // =========================================================================
 // Write to cache under spinlock (fast, no function calls)
 // =========================================================================
 ...
 // =========================================================================
 // Signal events OUTSIDE critical section (may log/allocate)
 // =========================================================================
...
size_t telemetryExportBinary(telemetry_packet_t* packet) {
 ...
 // Atomic copy into packed structure
