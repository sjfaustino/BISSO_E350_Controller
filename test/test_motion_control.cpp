...
void test_motion_validation_rejects_invalid_axis(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, 3, 1000, 50);
...
void test_motion_validation_rejects_zero_distance(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 0, 50);
...
void test_motion_validation_rejects_speed_too_low(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 1000, 0);
...
void test_motion_validation_rejects_speed_too_high(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 1000, 110);
...
void test_motion_validation_accepts_minimum_speed(void) {
  // Move at LSP (1 Hz)
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 1000, 1);
...
void test_motion_validation_accepts_maximum_speed(void) {
  // Move at HSP (105 Hz)
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 1000, 105);
...
void test_motion_soft_limits_prevent_overshoot_upper(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 7000, 50);
...
void test_motion_soft_limits_prevent_overshoot_lower(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, -10000, 50);
...
void test_motion_soft_limits_allow_valid_motion(void) {
  ...
  move_validation_result_t result =
      motion_mock_validate_move(&motion, AXIS_X, 2000, 50);
...
void test_stall_detection_high_current_no_motion(void) {
  ...
  for (int i = 0; i < 6; i++) {
    motion_mock_update(&motion, 1000, 0.0f, 9.0f,
                       100); // No movement, 9A current
  }
